        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                try {
                    ...
                    Log.d(TAG, "aquanotes Analytics trackEvent: "
                            + category + " / " + action + " / " + label + " / " + value);
                } catch (Exception e) {
                    // We don't want to crash if there's an Analytics library exception.
                    Log.w(TAG, "aquanotes Analytics trackEvent error: "
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                try {
                    ...
                    Log.d(TAG, "aquanotes Analytics trackPageView: " + path);
                } catch (Exception e) {
                    // We don't want to crash if there's an Analytics library exception.
                    Log.w(TAG, "aquanotes Analytics trackPageView error: " + path, e);
                }
                return null;
            }
        }.execute();
