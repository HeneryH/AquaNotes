 ...
 */
public class LivestockAdapter extends CursorAdapter {
    ...
    public LivestockAdapter(Activity activity) {
        super(activity, null);
        mActivity = activity;
    }
        ...
        if (mHasAllItem && position == 0) {
            if (convertView == null) {
                convertView = mActivity.getLayoutInflater().inflate(
                        R.layout.list_item_icon_two_line, parent, false);
            }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return mActivity.getLayoutInflater().inflate(R.layout.list_item_icon_two_line, parent,
                false);
    }
