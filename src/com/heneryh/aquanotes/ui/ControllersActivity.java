...
//        private NotesFragment mNotesFragment;
    ...
    /**
     * The workspace header shows the a title and figures out wheter or not to
...
//            cursor.close();
    ...
    public void onResume() {
        ...
        getContentResolver().registerContentObserver(
                AquaNotesDbContract.Controllers.CONTENT_URI, true, mControllerChangesObserver);
    }
...
//        } else if (token == ProbesQuery._TOKEN) {
//            onProbesQueryComplete(cursor);
//        } else if (token == OutletsQuery._TOKEN) {
   ...
   public void onControllersQueryComplete(Cursor cursor) {
        ...
        try {
        	...
        	while (cursor.moveToNext()) {
        		...
        		// Temp debug, leave the stub one in there
