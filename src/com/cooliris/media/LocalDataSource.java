...
public class LocalDataSource implements DataSource {
    ...
    public static final String URI_ALL_MEDx = MediaStore.Images.Media.INTERNAL_CONTENT_URI.toString();
    ...
    public void loadMediaSets(final MediaFeed feed) {
        ...
        if (mSingleUri) {
            ...
            if (mFlattenAllItems) {
                ...
                CacheService.loadMediaSets(mContext, feed, this, mIncludeImages, mIncludeVideos, true);  // got here on first start
            }
        } else {
