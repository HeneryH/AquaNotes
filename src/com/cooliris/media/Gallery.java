...
import com.heneryh.aquanotes.ui.controllers.ControllersActivity.MyIntentReceiver;
...
public class Gallery extends BaseMultiPaneActivity {
    public static final String REVIEW_ACTION = "com.cooliris.media.action.REVIEW";
    private static final String TAG = "Gallery";
    
    private static final int DIALOG_GENUS_LIST_CURSOR = 1;

	/**
	 * Receiver for status action broadcasts from; camera button
	 */
    MyIntentReceiver actionIntentReceiver;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case HANDLE_INTENT:
                    ...
                    break;
                default:
                	mApp.showToast("unhandled message", Toast.LENGTH_LONG);	;
            }
        }
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sendInitialMessage();
		  ...
		  */
	     actionIntentReceiver = new MyIntentReceiver();
    ...
    public void onResume() {
	    ...
	    IntentFilter intentFilter = new IntentFilter(HudLayer.ACTION_ADD_LIVESTOCK);
	    registerReceiver(actionIntentReceiver, intentFilter); 
    ...
    public void onPause() {
		...
		unregisterReceiver(actionIntentReceiver);
    ...
    public void onDestroy() {
        ...
        setContentView(Res.layout.activity_gallery_dummy);
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            case DIALOG_GENUS_LIST_CURSOR:
            	final Cursor cursor = managedQuery(AquaNotesDbContract.Genus.CONTENT_URI,
            								...
            								.setCursor(cursor,
            											new DialogInterface.OnClickListener() {
            												public void onClick(DialogInterface dialog, int which) {
                    											...
                    											String commonName = cursor.getString(GenusQuery.COMMON_NAME);
            													if(which==0) {
            														//new
            													} else {
            														//existing
...
//        	     String THUMBNAIL = "thumbnail";
                    BaseColumns._ID,
                    AquaNotesDbContract.Genus.COMMON_NAME,
                    AquaNotesDbContract.Genus.SCIENTIFIC_NAME,
                    AquaNotesDbContract.Genus.TIMESTAMP,
                    AquaNotesDbContract.Genus.THUMBNAIL,
        };
        int _ID = 0;
        int COMMON_NAME = 1;
        int SCIENTIFIC_NAME = 2;
        int TIMESTAMP = 3;
        int THUMBNAIL = 4;
     }
    ...
    public class MyIntentReceiver extends BroadcastReceiver {
		...
		/* For now, I just use the intent coming from the camera button to insert a dialog asking which genus to attach to the image. */
			Bundle resultData = intent.getExtras();
			int state = intent.getIntExtra(HudLayer.EXTRA_STATE, 0);
//			switch (state) {
//			case 0: {
//				break;
//			}
//			}
// skip dialog for now			showDialog(DIALOG_GENUS_LIST_CURSOR);
		}
    }
