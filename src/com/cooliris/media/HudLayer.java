...
import com.heneryh.aquanotes.ui.livestock.NewLivestockActivity;
...
public final class HudLayer extends Layer {
	...
	public static final String ACTION_ADD_LIVESTOCK = "com.heneryh.aquanotes.ADD_LIVESTOCK";
	public static final String EXTRA_STATE = "state";

    private final Runnable mCameraButtonAction = new Runnable() {
        public void run() {
//        	/* TODO: this needs to have a selector inserted in line before the camera */
//            // Launch the camera intent.
//            Intent intent = new Intent(MediaStore.INTENT_ACTION_STILL_IMAGE_CAMERA);
//            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
//            mContext.startActivity(intent);
//			Intent result = new Intent(ACTION_ADD_LIVESTOCK);
//			result.putExtra(EXTRA_STATE,0);
//			mContext.sendBroadcast(result);
          mContext.startActivity(new Intent(mContext, NewLivestockActivity.class));                
